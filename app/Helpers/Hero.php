...
class Hero
{
	...
	public static function get_hmbody($attrib1, $cid)
		{
			$mbody = Charac0::where('c_id', $cid)->first()->m_body;
			// dd($mbody);
	...
	public static function set_hmbody($attrib2, $newstring, $cid)
		{
			$mbody = Charac0::where('c_id', $cid)->first()->m_body;
			$temp = explode('\_1', $mbody);
			switch ($attrib2)
	...
	public static function set_cheadera($str, $int, $dex, $vit, $mana, $points, $cid)
		{
			$stat = Charac0::where('c_id', $cid)->first()->c_headera;
	...
	public static function get_cheadera($attrib, $cid)
		{
			$stat = Charac0::where('c_id', $cid)->first()->c_headera;
			$stat_temp = explode (';', $stat);
			switch($attrib)
