...
<div class="card">
	<div class="card-header">
		<h1>Mercenary Learn Passive Skill</h1>
	</div>
	<div class="card-body">
	@include('layouts.info')
	@include('layouts.errorform')

	<h6>Please take note that only passive skill at level 300 is available.</h6>

	<form method="POST" action="{{ route('merclearnpsvskill.store') }}" id="form" accept-charset="UTF-8" enctype="multipart/form-data">
		@csrf
