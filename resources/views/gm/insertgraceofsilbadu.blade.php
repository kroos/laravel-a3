...
<div class="card">
	<div class="card-header">
		<h1>Insert Grace Of Silbadu</h1>
	</div>
	<div class="card-body">
	@include('layouts.info')
	@include('layouts.errorform')

	<h6>As always, fill up the character input form below. Please take note that this will wipe off all the items in your inventory.</h6>

	<form method="POST" action="{{ route('insertgraceofsilbadu.store') }}" id="form" accept-charset="UTF-8" enctype="multipart/form-data">
		@csrf
