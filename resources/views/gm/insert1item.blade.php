...
<div class="card">
	<div class="card-header">
		<h1>Inserting 1 Item In The Inventory</h1>
	</div>
	<div class="card-body">
	@include('layouts.info')
	@include('layouts.errorform')

	<h6>Please take note that all of these item are the GM items</h6>

	<form method="POST" action="{{ route('insert1item.store') }}" id="form" accept-charset="UTF-8" enctype="multipart/form-data">
		@csrf
					...
					<div class="row_box">
						<div class="col-12 form-row">
							...
							<div class="col-8">
								...
								@foreach(config('a3.insert1item') as $k => $v)
									<optgroup label="{{ $k }}">
									@foreach($v as $l => $j)
