			...
			<div class="row">
				<div class="col-10 mx-auto">
					<form action="" method="GET" autocomplete="off" id="formuser" accept-charset="utf-8">
						...
						<div class="form-group row">
							<label for="simple-select2-sm" class="col-2 col-form-label">Example select</label>
							<div class="col-10">
						...
						<div class="form-group row">
							<label for="simple-select2" class="col-2 col-form-label">Example multiple select</label>
							<div class="col-10">
