...
<div class="card">
	...
	{!! Form::model($hero_points, ['route' => ['heropoints.update', $hero_points->c_id], 'method' => 'PATCH', 'id' => 'form', 'files' => true]) !!}
...
$('#hero').on('change', function() {
	// $selection = $(this).find(':checked');
	$selection = $(this).find(':checked');
	// console.log($selection.val());

	// ajax for finding hero type
	var data1 = $.ajax({
		url: "{{ url('/api/charac0/') }}/" + $selection.val(),
		type: "POST",
